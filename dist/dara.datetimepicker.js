...
class DateTimePicker {
  constructor(selector, options, message) {
    ...
    this._documentClickEvent = e => {
      if (this.isVisible && e.target != this.targetElement && !utils_1.default.closestElement(e.target, this.datetimeElement)) {
        this.hide();
      }
    };
  ...
  afterChangeDatepicker() {
    ...
    if (this.options.afterChangeDatepicker && utils_1.default.isFunction(this.options.afterChangeDatepicker)) {
  ...
  beforeChangeDatepicker() {
    const formatValue = this.currentDate.format(this.dateFormat);
    if (this.options.beforeChangeDatepicker && utils_1.default.isFunction(this.options.beforeChangeDatepicker)) {
            ...
            <div class="ddtp-body">
                <table class="ddtp-days">
                    <thead class="ddtp-day-header">
                        <tr>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[0]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[0])}</td>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[1]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[1])}</td>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[2]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[2])}</td>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[3]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[3])}</td>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[4]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[4])}</td>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[5]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[5])}</td>		
                            <td class="ddtp-day-label ${constants_1.DAY_STYLE_CLASS[this.dayOrder[6]]}">${Lanauage_1.default.getWeeksMessage(this.dayOrder[6])}</td>		
                        </tr>
                    </thead>
  ...
  yearDraw(beforeChangeDatepickerCheck) {
    ...
    if (beforeChangeDatepickerCheck !== false && this.initMode == constants_1.DateViewMode.year) {
    ...
    const beforeDrawDateFlag = utils_1.default.isFunction(this.options.beforeDrawDate);
  ...
  monthDraw(beforeChangeDatepickerCheck) {
    var _a;
    if (beforeChangeDatepickerCheck !== false && this.initMode == constants_1.DateViewMode.month) {
      this.beforeChangeDatepicker();
      return;
    }
    ...
    for (let i = 0; i < 12; i++) {
      ...
      calHTML.push(`<div class="ddtp-month ${addStylceClass}" data-month="${i}" ${tooltip}>${Lanauage_1.default.getMonthsMessage(i, "abbr")}</div>`);
    }
  ...
  dayDraw(beforeChangeDatepickerCheck) {
    if (beforeChangeDatepickerCheck !== false && (this.initMode == constants_1.DateViewMode.date || this.initMode == constants_1.DateViewMode.datetime)) {
      this.beforeChangeDatepicker();
      return;
    }
    ...
    for (let i = 0; i < 42; i++) {
      ...
      let addStylceClass = constants_1.DAY_STYLE_CLASS[this.dayOrder[i % 7]];
AA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,gCAAA;EACA,cAAA;EACA,WAAA;EACA,YAAA;EACA,gDAAA;EACA,kBAAA;EACA,UAAA;EACA,UAAA;EACA,gCAAA;AAlFR;AAqFM;EAEE,YAAA;EACA,iCAAA;AApFR;AAuFM;EACE,kDAAA;EACA,YAAA;EACA,YAAA;AArFR;AAuFQ;EACE,6BAAA;AArFV;;AA4FA;EACE;IACE,UAAA;EAzFF;EA4FA;IACE,UAAA;EA1FF;AACF;AA6FA;EACE;IACE,UAAA;EA3FF;EA8FA;IACE,UAAA;EA5FF;AACF","sourcesContent":[".dara-datetime-hidden {\r\n  visibility: visible;\r\n  width: 0px;\r\n  height: 0px;\r\n  z-index: 1000;\r\n}\r\n\r\n.dara-datetime-wrapper {\r\n  --color: #34495e;\r\n  --light: #ffffff;\r\n  --success: #0abf30;\r\n  --error: #e24d4c;\r\n  --warning: #e9bd0c;\r\n  --info: #3498db;\r\n  --background-color: #ffffff;\r\n  --sunday: #f00d0d;\r\n  --border-color: #d3d2d2;\r\n  --select-background-color: #0abf30;\r\n  --button-hover-color: #d4d4d48a;\r\n  --disabled-background-color: #f1f1f18a;\r\n  --today-bg: #a9d5ff;\r\n}\r\n\r\nbody.dark .dara-datetime-wrapper,\r\n.dara-datetime-wrapper.dark {\r\n  --color: #d0d6e1;\r\n  --light: #ffffff;\r\n  --success: #0abf30;\r\n  --error: #e24d4c;\r\n  --warning: #e9bd0c;\r\n  --info: #3498db;\r\n  --background-color: #070d19;\r\n  --sunday: #f00d0d;\r\n  --border-color: #6e7380;\r\n  --today-bg: #5660d9;\r\n  --today-color: #5660d9;\r\n  --select-background-color: #ffffff;\r\n  --button-hover-color: #31316c;\r\n  --disabled-background-color: #818181;\r\n}\r\n\r\n.dara-datetime-wrapper {\r\n  z-index: 1000;\r\n  display: none;\r\n\r\n  *,\r\n  *::before,\r\n  *::after {\r\n    box-sizing: content-box;\r\n    color: var(--color);\r\n  }\r\n\r\n  &.layer {\r\n    position: absolute;\r\n  }\r\n\r\n  input {\r\n    background-color: transparent;\r\n  }\r\n\r\n  &.show {\r\n    display: block;\r\n    animation: fadeIn 0.5s;\r\n    animation-fill-mode: forwards;\r\n  }\r\n\r\n  &.hide {\r\n    animation: fadeOut 0.5s;\r\n    animation-fill-mode: forwards;\r\n    //animation: daraToastHide 0.3s ease forwards;\r\n  }\r\n\r\n  &.embed {\r\n    display: block;\r\n  }\r\n\r\n  .sun {\r\n    & > span {\r\n      color: var(--sunday);\r\n    }\r\n  }\r\n\r\n  .ddtp-datetime {\r\n    border-radius: 4px;\r\n    padding: 10px;\r\n    width: 235px;\r\n    background-color: var(--background-color);\r\n    color: var(--color);\r\n    box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\r\n\r\n    &.rtl {\r\n      direction: rtl;\r\n\r\n      .ddtp-header {\r\n        .ddtp-header-year,\r\n        .ddtp-header-month {\r\n          float: right;\r\n        }\r\n\r\n        .ddtp-date-move {\r\n          float: left;\r\n        }\r\n      }\r\n\r\n      .ddtp-body .ddtp-times {\r\n        .time-container {\r\n          display: block;\r\n        }\r\n        & > .time-btn {\r\n          left: 0px;\r\n          right: auto;\r\n        }\r\n      }\r\n    }\r\n\r\n    &[view-mode=\"date\"] .ddtp-body > .ddtp-days {\r\n      display: block;\r\n    }\r\n\r\n    &[view-mode=\"datetime\"] {\r\n      .ddtp-body > .ddtp-times,\r\n      .ddtp-body > .ddtp-days {\r\n        display: block;\r\n      }\r\n    }\r\n\r\n    &[view-mode=\"time\"] {\r\n      .ddtp-body > .ddtp-times {\r\n        display: block;\r\n      }\r\n\r\n      .ddtp-header {\r\n        display: none;\r\n      }\r\n    }\r\n\r\n    &[view-mode=\"year\"] {\r\n      .ddtp-body > .ddtp-years {\r\n        display: flex;\r\n      }\r\n\r\n      .ddtp-header-month {\r\n        display: none;\r\n      }\r\n    }\r\n\r\n    &[view-mode=\"month\"] {\r\n      .ddtp-body > .ddtp-months {\r\n        display: flex;\r\n      }\r\n\r\n      .ddtp-header-month {\r\n        display: none;\r\n      }\r\n    }\r\n  }\r\n\r\n  .ddtp-header {\r\n    padding: 2px 5px 10px;\r\n    line-height: 25px;\r\n    height: 25px;\r\n    vertical-align: middle;\r\n\r\n    .ddtp-header-year {\r\n      font-weight: bold;\r\n      margin: 0px 10px 0px 0px;\r\n      cursor: pointer;\r\n    }\r\n\r\n    .ddtp-header-month {\r\n      font-weight: bold;\r\n      margin: 0px 10px 0px 0px;\r\n      vertical-align: top;\r\n      cursor: pointer;\r\n    }\r\n\r\n    .ddtp-date-move {\r\n      margin-left: auto;\r\n      vertical-align: top;\r\n      float: right;\r\n      direction: ltr;\r\n\r\n      .ddtp-move-btn {\r\n        text-decoration: none;\r\n        font-weight: bold;\r\n        display: inline-block;\r\n        height: 24px;\r\n\r\n        > svg {\r\n          fill: var(--color);\r\n        }\r\n\r\n        &:hover {\r\n          background-color: var(--button-hover-color);\r\n        }\r\n      }\r\n\r\n      &::after {\r\n        content: \"\";\r\n        clear: both;\r\n      }\r\n    }\r\n  }\r\n\r\n  .ddtp-body {\r\n    margin: -2px -10px;\r\n    font-size: 13px;\r\n\r\n    > * {\r\n      display: none;\r\n    }\r\n\r\n    button {\r\n      display: block;\r\n      width: 100%;\r\n      margin-bottom: 7px;\r\n      padding: 3px 0px;\r\n      border-radius: 4px;\r\n      border-color: var(--border-color);\r\n      border-width: 1px;\r\n      border-style: solid;\r\n      background-color: var(--background-color);\r\n\r\n      &:hover {\r\n        background-color: var(--button-hover-color);\r\n      }\r\n    }\r\n\r\n    .time-today {\r\n      &:hover {\r\n        background-color: var(--button-hover-color);\r\n      }\r\n    }\r\n\r\n    .ddtp-days {\r\n      letter-spacing: 0px;\r\n      border-collapse: separate;\r\n      border-spacing: 0px;\r\n      margin: 2px 10px;\r\n      width: inherit;\r\n\r\n      .ddtp-day-label {\r\n        font-weight: bold;\r\n        width: 35px;\r\n        padding: 2px 5px;\r\n        text-align: center;\r\n        line-height: initial;\r\n      }\r\n\r\n      .ddtp-day {\r\n        position: relative;\r\n        text-align: center;\r\n        padding: 7px;\r\n        cursor: pointer;\r\n        line-height: initial;\r\n\r\n        &.event::after {\r\n          content: \"•\";\r\n          color: #f78536;\r\n          font-size: 1.4em;\r\n          position: absolute;\r\n          left: 2px;\r\n          z-index: 10;\r\n          top: -7px;\r\n        }\r\n\r\n        &:before {\r\n          content: \"\";\r\n          position: absolute;\r\n          top: 50%;\r\n          left: 50%;\r\n          transform: translate(-50%, -50%);\r\n          display: block;\r\n          width: 30px;\r\n          height: 30px;\r\n          background-color: var(--select-background-color);\r\n          border-radius: 50%;\r\n          opacity: 0;\r\n          z-index: 0;\r\n          transition: opacity 0.2s ease-in;\r\n        }\r\n\r\n        &:active:before,\r\n        &:hover:before {\r\n          opacity: 0.7;\r\n          transition: opacity 0.2s ease-out;\r\n        }\r\n\r\n        &.today {\r\n          > span {\r\n            z-index: 2;\r\n            position: relative;\r\n          }\r\n\r\n          &:before {\r\n            background-color: var(--today-bg);\r\n            z-index: 1;\r\n            opacity: 1;\r\n            transition: opacity 0.2s ease-out;\r\n          }\r\n        }\r\n\r\n        &.select:before {\r\n          background-color: var(--select-background-color);\r\n          opacity: 0.5;\r\n          transition: opacity 0.2s ease-out;\r\n        }\r\n\r\n        &.old,\r\n        &.new {\r\n          opacity: 0.5;\r\n        }\r\n\r\n        &.disabled {\r\n          background-color: var(--disabled-background-color);\r\n          opacity: 0.5;\r\n          cursor: auto;\r\n\r\n          &:before {\r\n            background-color: transparent;\r\n          }\r\n        }\r\n      }\r\n    }\r\n\r\n    .ddtp-times {\r\n      margin: 2px 15px;\r\n      position: relative;\r\n\r\n      > .time-container {\r\n        width: calc(100% - 60px);\r\n        display: inline-block;\r\n        height: 60px;\r\n      }\r\n\r\n      input[type=\"number\"] {\r\n        -moz-appearance: textfield;\r\n        appearance: textfield;\r\n\r\n        &::-webkit-inner-spin-button,\r\n        &::-webkit-outer-spin-button {\r\n          -webkit-appearance: none;\r\n        }\r\n      }\r\n\r\n      > .time-btn {\r\n        position: absolute;\r\n        top: 9px;\r\n        width: 55px;\r\n        right: 0px;\r\n        > .time-select {\r\n          height: 40px;\r\n        }\r\n      }\r\n\r\n      .ddtp-time {\r\n        display: table-row;\r\n        width: 160px;\r\n\r\n        > * {\r\n          margin-top: 5px;\r\n          display: table-cell;\r\n          line-height: 20px;\r\n          vertical-align: middle;\r\n        }\r\n\r\n        > span {\r\n          width: 20px;\r\n        }\r\n\r\n        > input[type=\"number\"] {\r\n          width: 45px;\r\n          margin-right: 5px;\r\n          padding-left: 0px;\r\n          border-radius: 4px;\r\n          border-color: var(--border-color);\r\n          border-width: 1px;\r\n          text-align: center;\r\n        }\r\n\r\n        > input[type=\"range\"] {\r\n          width: calc(100% - 60px);\r\n        }\r\n      }\r\n    }\r\n\r\n    .ddtp-months {\r\n      flex-direction: row;\r\n      flex-wrap: wrap;\r\n      justify-content: space-between;\r\n\r\n      > .ddtp-month {\r\n        position: relative;\r\n        flex: 1 0 30%;\r\n        margin-bottom: 8px;\r\n        line-height: 50px;\r\n        text-align: center;\r\n        cursor: pointer;\r\n\r\n        &:before {\r\n          content: \"\";\r\n          position: absolute;\r\n          top: 50%;\r\n          left: 50%;\r\n          transform: translate(-50%, -50%);\r\n          display: block;\r\n          width: 50px;\r\n          height: 50px;\r\n          background-color: var(--select-background-color);\r\n          border-radius: 50%;\r\n          opacity: 0;\r\n          z-index: 0;\r\n          transition: opacity 0.2s ease-in;\r\n        }\r\n\r\n        &:active:before,\r\n        &:hover:before {\r\n          opacity: 0.5;\r\n          transition: opacity 0.2s ease-out;\r\n        }\r\n\r\n        &.disabled {\r\n          background-color: var(--disabled-background-color);\r\n          opacity: 0.5;\r\n          cursor: auto;\r\n\r\n          &:before {\r\n            background-color: transparent;\r\n          }\r\n        }\r\n      }\r\n    }\r\n  }\r\n\r\n  .ddtp-years {\r\n    flex-direction: row;\r\n    flex-wrap: wrap;\r\n    justify-content: space-between;\r\n\r\n    > .ddtp-year {\r\n      position: relative;\r\n      flex: 1 0 25%;\r\n      margin-bottom: 8px;\r\n      line-height: 50px;\r\n      text-align: center;\r\n      cursor: pointer;\r\n\r\n      &:before {\r\n        content: \"\";\r\n        position: absolute;\r\n        top: 50%;\r\n        left: 50%;\r\n        transform: translate(-50%, -50%);\r\n        display: block;\r\n        width: 50px;\r\n        height: 50px;\r\n        background-color: var(--select-background-color);\r\n        border-radius: 50%;\r\n        opacity: 0;\r\n        z-index: 0;\r\n        transition: opacity 0.2s ease-in;\r\n      }\r\n\r\n      &:active:before,\r\n      &:hover:before {\r\n        opacity: 0.5;\r\n        transition: opacity 0.2s ease-out;\r\n      }\r\n\r\n      &.disabled {\r\n        background-color: var(--disabled-background-color);\r\n        opacity: 0.5;\r\n        cursor: auto;\r\n\r\n        &:before {\r\n          background-color: transparent;\r\n        }\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n@keyframes fadeIn {\r\n  from {\r\n    opacity: 0;\r\n  }\r\n\r\n  to {\r\n    opacity: 1;\r\n  }\r\n}\r\n\r\n@keyframes fadeOut {\r\n  from {\r\n    opacity: 1;\r\n  }\r\n\r\n  to {\r\n    opacity: 0;\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
